/*
** $Id: menubutton.c 7329 2007-08-16 02:59:29Z xgwang $
**
...
static void draw_small_triangle (HDC hdc, int l, int r, int t, gal_pixel c)
{
    SetPenColor (hdc, c); 
    for ( ; l <= r; l++, r--, t++) {
        MoveTo (hdc, l, t);
...
/*                     rcMenuBar.right, rcMenuBar.bottom, 0, DF_3DBOX_NORMAL | DF_3DBOX_FILL, bk_color); */
        draw_small_triangle (hdc, rcMenuBar.left, rcMenuBar.right,
                             rcMenuBar.top, GetWindowElementColor (WEC_FLAT_BORDER));
...
/*                            rcMenuBar.right, rcMenuBar.bottom, DF_3DBOX_NORMAL | DF_3DBOX_FILL, bk_color); */
        draw_small_triangle (hdc, rcMenuBar.left, rcMenuBar.right,
                             rcMenuBar.top, GetWindowElementColorEx (hWnd, WEC_3DBOX_DARK));
#endif
        EndPaint (hWnd, hdc);
        return 0;
    }
