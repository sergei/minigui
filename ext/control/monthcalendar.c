...
#define TEXT_BORDER      5 #define LINE_D           2
...
#define MCCLR_DF_TITLEBK        PIXEL_darkgray
#else
//#define MCCLR_DF_TITLEBK        PIXEL_lightgray
#define MCCLR_DF_TITLEBK       RGB2Pixel(HDC_SCREEN, 0xD6, 0xD3, 0xCE) 
#endif
...
#ifdef _FLAT_WINDOW_STYLE
#define MCCLR_DF_WEEKCAPTBK        PIXEL_black
#else
